                ...
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">SEUS DADOS NA NUVEM,</tspan><br><tspan x="3.75" y="145">ACESSÍVEIS DE QUALQUER LUGAR</tspan></text>
                         </div>  
                    </div>
                </div>
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannercloud3">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                        <text class="a"><tspan x="117.583" y="65">SEGURANÇA EM CASOS DE DANOS,</tspan><br><tspan x="3.75" y="145">INVASÕES OU QUALQUER TIPO DE </tspan><br><tspan x="3.75" y="145">ATAQUE AO SEU SISTEMA</tspan></text>
                         </div>  
                    </div>
                </div>  
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannercloud4">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">GANHE MAIS MOBILIDADE E</tspan><br><tspan x="3.75" y="145">FACILIDADE DE ACESSO</tspan></text>
                         </div>  
                    </div>
                </div>
                <div class="row" style="text-align: center;">
