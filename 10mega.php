...
<head>
   ...
   ?>      
                    ...
                    <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                        <div class="col-xl-12 posts-list">
                           <div class="single-post">
                              <text class="a"><tspan x="117.583" y="65">ELE É PEQUENO, MAS</tspan><br><tspan x="3.75" y="145">SEMPRE ATENTO E FIEL</tspan></text>
                             </div>  
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 p-0">
                <div class="banner10-2">
                    <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                        <div class="col-xl-12 posts-list">
                           <div class="single-post">
                              <text class="a"><tspan x="117.583" y="65">ELA PRECISA DE</tspan><br><tspan x="3.75" y="145">ATENÇÃO E COMPANHIA</tspan></text>
                             </div>  
                        </div>
                    </div> 
                </div>
    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-12 p-0">
                <div class="banner10-3">
                    <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                            <div class="col-xl-12 posts-list">
                               <div class="single-post">
                                  <text class="a"><tspan x="117.583" y="65">DELICADEZAS QUE</tspan><br><tspan x="3.75" y="145">PROVOCAM CONEXÕES</tspan></text>
                                 </div>  
                            </div>
                    </div>
