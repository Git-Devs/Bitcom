...
$rs = pg_query($conn,"select * from db_informativo where id_informativo = $id_informativo;");
...
echo        '<div class="col-9">
            <div data-spy="scroll" data-target="img" data-offset="0" >
                <h4 style="font-size: 28px;">'.$row['titulo'].'</h4>
                    <p class="info">Publicado em '.$data_inserida.' |<br> <span class="hidden-xs sharing" data-url="#"></span></p>
                     <p>';

                     if(trim($row['imagem']) != "")
                        echo '<img src="admin/administrador/img_produtos/'.$row['imagem'].'">';
                    else
                        echo '&nbsp;';
                    ...
                    if(trim($row['documento']) != "")
                        echo '<a href=admin/administrador/documentos/'.$row['documento'].' target="_new">Clique e visualize o documento</a>';
                    else
                        echo '&nbsp;';
