                ...
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">COMUNICAÇÃO INSTANTÂNEA,</tspan><br><tspan x="3.75" y="145">CLARA E SEM DORES DE CABEÇA</tspan></text>
                         </div>  
                    </div>
                </div>
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannerfone3">
 
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">QUALIDADE,</tspan><br><tspan x="3.75" y="145">ECONOMIA E AGILIDADE</tspan></text>
                         </div>  
                    </div>
                </div>  
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannerfone4">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">OPÇÕES IDEAIS PARA PEQUENAS,</tspan><br><tspan x="3.75" y="145">MÉDIAS E GRANDES EMPRESAS</tspan></text>
                         </div>  
                    </div>
                </div>
                <div class="row" style="text-align: center;">
