                ...
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">QUANTIDADE DE ESPAÇO E</tspan><br><tspan x="3.75" y="145">RECURSOS PERSONALIZADOS</tspan></text>
                         </div>  
                    </div>
                </div>
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannerdominio3">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                        <text class="a"><tspan x="117.583" y="65">UMA PLATAFORMA COM</tspan><br><tspan x="3.75" y="145">ESTRUTURA ROBUSTA</tspan></text>
                         </div>  
                    </div>
                </div>  
            </div>
