...
$rs = pg_query($conn,"select * from db_minuta order by data_validade ASC");
...
echo        '<div class="col-9">
            <div data-spy="scroll" data-target="img" data-offset="0" >
                <a href="#"><h4 style="font-size: 28px;">'.$row['titulo'].' <a href="admin/administrador/documentos/'.$row['documento'].'" target="_new"><img src="imagem_documento.jpg"></a></h4>
                    <p>'.$row['descricao'].'
                    </p>
