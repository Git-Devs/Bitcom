    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-12 p-0">
                <div class="bannerseguros1">
                    <div class="row" style="text-align: center;">
                        <div class="col-xl-12" style="top: 715px;">
                            <div class="slider_text">
                                <div class="btn-mobile">
                                    <a class="boxed-btn3" data-toggle="modal" data-target="#examplepopup">Garanta o seu</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannerseguros2">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">SEGUROS CRIADOS PARA</tspan><br><tspan x="3.75" y="145">PESSOAS COMO VOCÊ</tspan></text>
                         </div>  
                    </div>
                </div>
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannerseguros3">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                        <text class="a"><tspan x="117.583" y="65">QUE SABE A IMPORTÂNCIA DE</tspan><br><tspan x="3.75" y="145">GARANTIR A PROTEÇÃO </tspan></text>
                         </div>  
                    </div>
                </div>  
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannerseguros4">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">SEGUROS PESSOAIS,</tspan><br><tspan x="3.75" y="145">AGRONEGÓCIOS, RESIDENCIAS,</tspan><br><tspan x="3.75" y="145">MASSIFICADOS E CORPORATIVOS</tspan></text>
                         </div>  
                    </div>
                </div>
                <div class="row" style="text-align: center;">
                    <div class="col-xl-12" style="top: 40px;">
                        <div class="slider_text">
                            <div class="btn-mobile">
                                <a class="boxed-btn3" data-toggle="modal" data-target="#examplepopup">Garanta o seu</a>
                            </div>
...
">X</span>
            ...
            <div class="modal-body our_department_area_popup">
                <div class="container">            
                    <div class="row">
                        <div class="col-12">
                        <h1 style="font-family: Segoe UI regular;font-size: 21px;color: white;">Informe os dados a baixo e em breve enviaremos a melhor oferta!</h1></div>
                        <div class="col-12">  
                            
                            <!------------------------FORMULÁRIO MIGRAÇÃO--------------------------->
                                <form action="salvar_consulta_disponibilidade.php" method="POST" class="form-inline" style="padding-top: 5px;padding-bottom: 0px;padding-top: 26px;margin-left: 30px;">
                                    <label class="sr-only" for="inlineFormInputName2"></label>
                                        <div class="col-xl-12" style="top: 0px;">
                                            <input type="text" name='nome' class="form-control mb-2 mr-sm-2" id="inlineFormInputName" placeholder="Informe seu Nome" required style="margin-top: 10px;margin-left: 6px;border-radius: 7px;color: black;background-color: white;font-size: 20px;">
                                        </div>
                                        <div class="col-12">
                                            <label class="sr-only" for="inlineFormInputName2"></label>
                                        <div class="col-xl-12" style="top: 0px;">
                                            <input type="text" name='cep' class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="CEP" onkeypress="mascara(this, '#####-###')" maxlength="9" required style="margin-top: 10px;margin-left: 6px;border-radius: 7px;color: black;background-color: white;font-size: 20px;">
                                        </div>
                                        <div class="col-xl-12" style="top: 0px;">
                                            <div class="form-group">
                                                <label for="inputtext"></label>
                                                    <div class="col-xl-12" style="top: 0px;">
                                                        <input name='telefone' type="text" id="inputtext" placeholder="Seu telefone"  onkeypress="mascara(this, '## #####-####')" maxlength="13" required class="form-control mx-sm-3" aria-describedby="passwordHelpInline" style="margin-top: 10px;margin-left: 0px;border-radius: 7px;color: black;background-color: white;font-size: 20px;">
                                                    </div> 
                                                <small id="passwordHelpInline" class="text"></small>
                                            </div>
                                        </div>
                                    <button type="submit" class="btn btn-primary mb-2" style="margin-top: 10px;margin-left: 10px;border-radius: 7px;color: white;background-color: red;font-size: 20px;">Enviar</button>
                                </form>
                            <!------------------------FORMULÁRIO--------------------------->
...
<div class="modal modal-home container" id="mensagens" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered row" role="document">
        <div class="modal-content" style="background-color: white;">        
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span class="close-button" aria-hidden="true" style="background-color: red;font-size: 15px;border-radius: 40px;height: 40px; width: 40px;padding-top: 13pxmargin-bottom: 4px;">X</span>
            </button>
            <div class="modal-body our_department_area_popup">
                <div class="container">            
                    <div class="row">
