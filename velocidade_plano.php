...
">
    ...
    color: #A91114;
    padding-top: 15px;
">Porque minha velocidade não está</div>
<br>
<br>
<div  style="
    font-size: 21px;
    ...
    padding-bottom: 50px;
    margin-top: -40px;
"> compatível com o plano contratado?</div>
...
">
    ...
    <div class="bradcam_area_velocidade_plano breadcam_bg_velocidade_plano bradcam_overlay">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
...
<div id="accordion" style=" text-align: left; padding-top: 100px;">
    <div class="cardfaq">
      <div class="card-headerfaq" id="headingOne">
        <h5 class="mb-0">
          
                <h1 style="background-color:#e0e0e0;height:39px; font-family: Segoe UI semibold; font-size: 30px;"> FAQ <br> </h1>
                <br>
                <br>
                <h3>Porque minha velocidade não está compatível com o plano contratado?</h3>
                <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">A Bitcom se compromete com a velocidade da internet e, para fazer o teste da velocidade, pedimos
                                que não o faça pelo Wi-Fi (visto que por tal meio fica impossível de garantir condições confiáveis em
                                relação a velocidade, devido as interferências externas). Utilize sempre o cabo conectado em um
                                computador e se atente sempre às características técnicas de hardware e software dos dispositivos
                                utilizados, elas podem influenciar diretamente no resultado e na qualidade de sua conexão.</p>
                <!-- <br> -->
                <!-- <h3>Em seguida:</h3> -->
                <!-- <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">Menu > Finanças > Documentos em aberto > Imprimir Boleto.</p>
                <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">Da mesma forma, é possivel adicionar seu cartão de crédito para pagar as mensalidades recorrentes pelo cartão.</p>
                <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">Menu > Cadastro > Adicionar Cartão.</p>
                <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">Além disso, também é possível efetuar o pagamento na lotérica informando o CPF do titular juntamente com o  código cedente.</p>
                <br>
                <h3>Códigos:</h3>
                <br>
                <p style="font-family: Segoe UI semibold;
        ...
        background-color: #332F2F;">
                <div class="col-xl-4 col-md-12">
                    <div class="section_title text-left mb-55">
                        <h3 style="text-align: center;font-size:21px; font-family: Segoe UI semibold;top: 40px;">Migre para Bitcom e ganhe <b style="font-weight:bold;color:white;">&nbsp;50% de desconto</b> na instalação </h3>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-12" style="top: 32px;">
                    <div class="section_title text-center mb-55 mobile">
                        <div class="btn-mobile">
                         <input type="submit" class="boxed-btn3" value="Quero Migrar"  style="font-family: Segoe UI semibold;font-size: 21px;" required>
                     </div>
                </form>
            </div>
        </div>
