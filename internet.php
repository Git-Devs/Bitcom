    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-12 p-0">
                <div class="bannerinternet1">
                    <div class="row" style="text-align: center;">
                        <div class="col-xl-12" style="top: 715px;">
                            <div class="slider_text">
                                <div class="btn-mobile">
                                    <a class="boxed-btn3" data-toggle="modal" data-target="#examplepopup">Consultar disponibilidade</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">GARANTIA DA ESTABILIDADE</tspan><br><tspan x="3.75" y="145">QUE VOCÊ PRECISA</tspan></text>
                         </div>  
                    </div>
                </div>
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannerinternet3">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                        <text class="a"><tspan x="117.583" y="65">VOCÊ COM TOTAL CONTROLE SOBRE</tspan><br><tspan x="3.75" y="145">A UTILIZAÇÃO E HISTÓRICOS</tspan></text>
                         </div>  
                    </div>
                </div>  
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannerinternet4">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">ATENDEMOS QUALQUER </tspan><br><tspan x="3.75" y="145">LOCALIZAÇÃO, COM ACESSOS</tspan><br><tspan x="3.75" y="145">DEDICADOS E REDUNDANTES</tspan></text></text>
                         </div>  
                    </div>
                </div>
                <div class="row" style="text-align: center;">
                    <div class="col-xl-12" style="top: 40px;">
                        <div class="slider_text">
                            <div class="btn-mobile">
                                <a class="boxed-btn3" data-toggle="modal" data-target="#examplepopup">Garanta a sua</a>
                            </div>
                        </div>
                        </div>
                    </div>  
...
<input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="CEP" required style="
    margin-top: 10px;
    margin-left: 6px;
    border-radius: 7px;
    color: black;
...
<div class="form-group">
                                        ...
                                        <div class="col-xl-12" style="top: 0px;">
<input type="text" id="inputtext" placeholder="Seu telefone" required class="form-control mx-sm-3" aria-describedby="passwordHelpInline" style="
                                    margin-top: 10px;
                                    margin-left: 0px;
                                    border-radius: 7px;
                                    color: black;
                                 ...
                                 <button type="submit" class="btn btn-primary mb-2" style="margin-top: 10px;margin-left: 460px;border-radius: 7px;color: white;background-color: red;font-size: 20px;">Enviar</button>
                            </form>
                            <!--LOGIN-->
                            <!--RELEMBRAR-->
