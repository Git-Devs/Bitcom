...
">
    ...
    <div class="bradcam_area_internetlenta breadcam_bg_internetlenta bradcam_overlay">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
    ...
    <div class="cardfaq">
      <div class="card-headerfaq" id="headingOne">
        <h5 class="mb-0">
                ...
                <br>
                <br>
                <h3>Se estiver enfrentando problemas de conexão ou lentidão, siga os passos:</h3>
                <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">1. Desligue o modem e o roteador</p>
                <br>
                <!-- <h3>Em seguida:</h3> -->
                
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">2. Desconecte e reconecte os cabos e, em seguida, religue os equipamentos.</p>
                <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">3. Aguarde até as luzes estarem acessas;
                </p>
                <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">4. Faça um limpeza no seu navegador, excluindo cookies e arquivos temporários;</p>
                <br>
                <p style="font-family: Segoe UI semibold;
                font-size: 18px;">Se a internet continuar lenta, ligue para a nossa Central de Atendimento.</p>
                <br>
                <!-- <h3>Códigos:</h3> -->
                <br>
                <!-- <p style="font-family: Segoe UI semibold;
