<!doctype html>
  ...
  <!-- bradcam_area_start  -->
  <div class="bradcam_area-single breadcam_bg-single bradcam_overlay-single">
   <div class="container">
...
">
            <div class="col-xl-12 posts-list">
               <div class="single-post">
                  <text class="a"><tspan x="117.583" y="65">ELA VALORIZA MAIS</tspan><br><tspan x="3.75" y="145">A SEGURANÇA NA RELAÇÃO</tspan></text>
                 </div>  
            </div>
         </div>
      </div>
...
">
            <div class="col-xl-12 posts-list">
               <div class="single-post">
                  <text class="a"><tspan x="117.583" y="65">PARA ELE O AMOR É UM</tspan><br><tspan x="3.75" y="145">TREM DESGOVERNADO</tspan></text>
...
<footer class="footer3">
    <div class="footer_top3">
       <div class="container">
          <div class="row" style="
             ...
             <div class="col-xl-12 posts-list">
                <div class="single-post">
                   <text class="a"><tspan x="117.583" y="65">DIFERENÇAS QUE PROVOCAM</tspan><br><tspan x="3.75" y="145">UMA FORTE CONEXÃO</tspan></text>
                  </div>
 ...
 <div style="  
  width: 100%;
  border-bottom: 20px solid #ffffff;"></div>
 <!-- footer end3 -->
