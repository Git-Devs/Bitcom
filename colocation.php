                ...
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">ALOQUE OS SEUS SERVIÇOS EM</tspan><br><tspan x="3.75" y="145">HARDWARE DE PARCEIROS</tspan></text>
                         </div>  
                    </div>
                </div>
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannercolocation3">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                        <text class="a"><tspan x="117.583" y="65">DIVIDA CUSTOS DE ESTRUTURAS,</tspan><br><tspan x="3.75" y="145">COMO MANUTENÇÃO, ENERGIA</tspan><br><tspan x="3.75" y="145">ELÉTRICA E CLIMATIZAÇÃO</tspan></text>
                         </div>  
                    </div>
                </div>  
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="bannercolocation4">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">ECONOMIZE EM ESTRUTURA</tspan><br><tspan x="3.75" y="145">PARA GERENCIAR SERVIDORES</tspan></text>
                         </div>  
                    </div>
                </div>
                <div class="row" style="text-align: center;">
