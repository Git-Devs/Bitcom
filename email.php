                ...
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">MAIOR CREDIBILIDADE DIANTE</tspan><br><tspan x="3.75" y="145">DOS CLIENTES E FORNECEDORES</tspan></text>
                         </div>  
                    </div>
                </div>
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="banneremail3">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                        <text class="a"><tspan x="117.583" y="65">BACKUP PRÓPIO E CONTROLE TOTAL</tspan><br><tspan x="3.75" y="145">DO TRÁFEGO DE INFORMAÇÕES</tspan></text>
                         </div>  
                    </div>
                </div>  
            </div>
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-12 p-0">
            <div class="banneremail4">
                <div class="row" style="font-size: 48px;color: white;font-family: Segoe UI regular;padding-top: 445px;display: flow-root;">
                    <div class="col-xl-12 posts-list">
                       <div class="single-post">
                          <text class="a"><tspan x="117.583" y="65">SERVIDORES DEDICADOS</tspan><br><tspan x="3.75" y="145">PARA O SEU DOMÍNIO E SUAS</tspan><br><tspan x="3.75" y="145">CONTAS DE E-MAIL</tspan></text>
                         </div>  
                    </div>
                </div>
                <div class="row" style="text-align: center;">
